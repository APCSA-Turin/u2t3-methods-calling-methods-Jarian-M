package U2T3_MethodOverloading;
...
public class Adder {
    ...
    public Add(String name, int increment, int counter) {
        this.name = name;
        this.counter = counter;
        this.increment = increment;
    }
    ...
    public int adder(int num2, int num1) {
        return num1 + num2;
    }
    ...
    public int adder(double num1, double num2) {
        int casted = (int) (num1 + num2);
        return casted;
    }
    ...
    public double adder(int num1, int num2, double num3) {
